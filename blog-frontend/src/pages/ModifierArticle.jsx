...
import { getArticle, modifierArticle } from "../services/api";
...
function ModifierArticle() {
            ...
            try {
                ...
                if (data.article) {
                    setFormData({
                        ...
                        est_public: data.article.est_public,
                        commentaires_actives: data.article.commentaires_actives
                    });
                } else {
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true);
        try {
            const data = await modifierArticle(
                id,
                formData.titre,
                formData.contenu,
                formData.est_public,
                    ...
                    <div className="col-md-8">
                        <div className="card shadow">
                            <div className="card-body p-4">
                                <h2 className="card-title mb-4">✏️ Modifier l'Article</h2>
